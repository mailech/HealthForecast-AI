...
const admissionSchema = new mongoose.Schema({
  ...
  payerCode: {
    type: String,
    default: 'MC' // Mode imputed default
  },
  medicalSpecialty: {
    type: String,
    default: 'InternalMedicine' // Mode imputed default
  },
  weight: {
    type: Number,
    default: 75.0 // Median/imputed midpoint in kg
  },
  weightWasMissing: {
    type: Boolean,
    default: true // Explicit missingness indicator
  }
});
