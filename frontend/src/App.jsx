        ...
        <Routes>
          ...
          <Route path="/" element={<DashboardLayout />}>
            ...
            <Route 
              ...
              element={
                <ProtectedRoute allowedRoles={['researcher', 'system_admin']}>
                  <ResearcherDashboard initialTab="analytics" />
                </ProtectedRoute>
              } 
            />
            <Route 
              path="researcher/clinical-outcomes" 
              element={
                <ProtectedRoute allowedRoles={['researcher', 'system_admin']}>
                  <ResearcherDashboard initialTab="outcomes" />
                </ProtectedRoute>
              } 
            />
            <Route 
              path="researcher/population-studies" 
              element={
                <ProtectedRoute allowedRoles={['researcher', 'system_admin']}>
                  <ResearcherDashboard initialTab="population" />
                </ProtectedRoute>
              } 
            />
            <Route 
              path="researcher/treatment-effectiveness" 
              element={
                <ProtectedRoute allowedRoles={['researcher', 'system_admin']}>
                  <ResearcherDashboard initialTab="treatment" />
                </ProtectedRoute>
              } 
            />
