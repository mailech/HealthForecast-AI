    ...
    <div className="page-container" style={{ maxWidth: '1200px' }}>
      ...
      <div className="card" style={{ display: 'flex', gap: '2rem', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <button className="btn btn-secondary" onClick={() => setShowReportModal(true)} title="Print Clinical Report">
            <FaPrint />
      ...
      {showReportModal && (
        <ClinicalReportModal
          ...
          reportType="Patient Clinical Summary Report"
          clinicianName={patient.assignedDoctor?.name || user?.name || 'Dr. Ruchika Patil, MD'}
        />
      )}
    </div>
  );
