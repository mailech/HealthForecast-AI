...
function MainLayout() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex bg-slate-100 font-sans antialiased text-slate-800 relative">
      ...
      <aside
        className={`h-full bg-slate-900 text-white flex flex-col shrink-0 border-r border-slate-800/80 shadow-xl z-50 transition-all duration-300 ${
          // Desktop width
      ...
      >
        {/* Brand Logo Header */}
        <div className={`p-6 border-b border-slate-800/80 flex items-center justify-between ${isCollapsed ? "lg:px-4 lg:justify-center" : ""}`}>
            ...
            {(!isCollapsed || isMobileOpen) && (
              <div>
                <h1 className="font-black text-lg tracking-tight text-white flex items-center gap-1.5">
                  HealthForecast <span className="text-blue-400">AI</span>
                </h1>
        ...
        {(!isCollapsed || isMobileOpen) && (
          <div className="mx-4 mt-4 p-2.5 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-between text-xs">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3.5 px-3.5 py-3 rounded-xl font-medium transition-all duration-200 ${
                  isActive
                    ? "bg-blue-600/15 text-blue-400 font-semibold border-l-4 border-blue-500 rounded-r-xl shadow-xs"
        ...
        <div className="hidden lg:flex p-4 border-t border-slate-800/80">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-800/80 rounded-xl transition-colors cursor-pointer"
          >
            {isCollapsed ? (
